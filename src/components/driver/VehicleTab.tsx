...
export const VehicleTab = () => {
  ...
  const vehicleOnboardingForm = useForm({
    resolver: zodResolver(vehicleOnboardingSchema),
    defaultValues: {
      vehicleType: "bike" as "bike" | "auto" | "car" | "truck" | "van",
      vehicleNumber: "",
      vehicleModel: "",
      yearOfManufacture: "",
      licenseNumber: "",
  ...
  const onVehicleOnboardingSubmit = (data: z.infer<typeof vehicleOnboardingSchema>) => {
